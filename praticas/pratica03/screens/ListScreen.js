  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.item}>
        ...
        <Text style={styles.itemSubtitle}>Breve descrição do item 1</Text>
      </View>
      <View style={styles.item}>
        <Text style={styles.itemTitle}>Título do item 2</Text>
        <Text style={styles.itemSubtitle}>Breve descrição do item 2</Text>
      </View>
      <View style={styles.item}>
        <Text style={styles.itemTitle}>Título do item 3</Text>
        <Text style={styles.itemSubtitle}>Breve descrição do item 3</Text>
      </View>
      <View style={styles.item}>
        <Text style={styles.itemTitle}>Título do item 4</Text>
        <Text style={styles.itemSubtitle}>Breve descrição do item 4</Text>
      </View>
    </View>
  )
}
